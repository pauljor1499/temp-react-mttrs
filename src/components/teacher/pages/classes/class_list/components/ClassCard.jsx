import { Grid, Button, Card, CardActions, CardContent, CardMedia, Typography, useTheme } from "@mui/material";
...
const ClassCard = ({ teacherClass }) => {
    ...
    const viewSelectedClass = (classCode, classTitle, classSection, classUUID) => {
        navigate(`/teacher/classes/${classTitle}`, {
            state: { classCode: classCode, classSection: classSection, classUUID: classUUID },
        });
    };

    return (
        <Card variant="outlined">
            <CardMedia component="img" image={classImage} alt="random" sx={{ height: 100 }} />
            <CardContent>
                <Grid container spacing={1}>
                    ...
                    <Grid container direction="row" justifyContent="space-between" alignItems="center" columns={16}>
                        ...
                        <Grid item md={8} sx={{ display: "flex", justifyContent: "flex-end", pr: 1 }}>
