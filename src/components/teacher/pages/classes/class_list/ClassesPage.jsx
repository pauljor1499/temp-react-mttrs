...
const noClassEntries = () => {
    return (
        <Grid sx={{ mt: 6 }} container direction="column" justifyContent="center" alignItems="center">
            <Grid item>
...
const noResultsFound = () => {
    return (
        <Grid sx={{ mt: 6 }} container direction="column" justifyContent="center" alignItems="center">
            <Grid item>
                <img height={250} width="auto" src={no_results} alt={no_results} />
            </Grid>
            <Grid item>
                <Typography sx={{ mx: "auto" }} variant="h6">
                    No results found
...
const renderClasses = (classData, searchInput) => {
    if (classData !== null) {
        if (filteredList(classData, searchInput).length === 0 && searchInput !== "") {
            return <Fade in={searchInput !== ""}>{noResultsFound()}</Fade>;
                ...
                <Box>
                    ...
                    >
                        <Grid
                            ...
                            container
                            columns={16}
                            direction={!tabletSize ? "row" : "column"}
                            justifyContent="space-between"
                        >
                            <Grid item>
                                <TextField
                                    fullWidth={!tabletSize ? false : true}
                                    sx={{
                                        minWidth: !tabletSize ? 350 : 100,
                                        // height: 100
                                    }}
                                    id="searchInputField"
